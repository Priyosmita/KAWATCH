...
const TransactionBar = ({ setPrediction, setProbability }) => {  // passing setPrediction and setProbability to be used in other components by importing, this is called defactoring
  ...
  return (
    <div className='outline outline-slate-600 rounded-lg p-6 ml-2 mr-1  mt-5 w-full max-w-md text-lg'>
      <div className='mb-12 text-2xl'>
        <p>Prediction Type</p>
        <select className='w-full p-2 border border-gray-400 rounded text-black'>
