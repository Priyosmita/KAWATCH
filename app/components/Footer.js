      ...
      <div className="flex flex-col mt-16 space-y-4 text-2xl">
        <div className='flex flex-col gap-y-11'>
          ...
          <div className="flex items-center transform duration-300 hover:scale-110 cursor-pointer">
            <span className="text-[#f5f7f8] hover:text-[#7da0ff]">Phone: +91 8777836723</span>
          </div>
          <div className="flex items-center transform duration-300 hover:scale-110 cursor-pointer">
            <span className="text-[#f5f7f8] hover:text-[#7da0ff]">Email: daspriyosmita2003@gmail.com</span>
          </div>
        </div>
      </div>
      <div>  { /* About column */}
        <div className="flex items-center transform duration-300 hover:scale-110 cursor-pointer mr-56">
          <span className="text-[#f5f7f8] text-3xl hover:text-[#7da0ff]">About</span>
        </div>
      </div>
    </footer>
  );
